            ...
            <Container>
                {shouldShowDecisionScreen ? (
                    ...
                    <Splitview
                        leftComponent={
                            <>
                                {currentStep === RegisterRouterSteps.Start && <StartRegistrationInfo />}
                                {currentStep === RegisterRouterSteps.VotingPower && <VotingPowerWizardInfo />}
                                {currentStep === RegisterRouterSteps.ReadyToStake && (
                                    <ConfirmationWizardInfo nextEpochStats={nextEpochStats} />
                                )}
                                {currentStep === RegisterRouterSteps.Success && <RegistrationSuccessInfo />}
                            </>
                        }
                        rightComponent={
                            <>
    ...
    return (
        <Section isTextCentered={true} isPadded={true} padding="80px 0 80px">
            ...
            <Flex>
                ...
                >
                    <Column>
                        <Text fontColor={colors.black} fontFamily="Formular" fontSize="28px" textAlign="center">
                            Register
                        </Text>
                        <List>
                            <Item>
                            ...
                            <Item>
                                <ListIcon src="/images/governance/list_icon.svg" />
                                You can still opt in to staking later. Staking takes effect at the beginning of an
                                epoch.
                            </Item>
                        </List>
                        <Button isFullWidth={true} onClick={onClose} color={colors.white}>
                            Register your ZRX
                        </Button>
                    </Column>
                </Section>
                ...
                >
                    <Column>
                        ...
                        <Button isFullWidth={true} to={WebsitePaths.StakingWizard} color={colors.white}>
