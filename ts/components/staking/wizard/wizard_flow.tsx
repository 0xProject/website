                ...
                <PoolsContainer>
                    {recommendedPools.map(rec => {
                        return (
                            <MarketMaker
                                key={rec.pool.poolId}
                                name={utils.getPoolDisplayName(rec.pool)}
        ...
        <>
            ...
            <PoolsContainer>
                <MarketMaker
                    ...
                    name={utils.getPoolDisplayName(marketMakerPool)}
                            ...
                            : // Default case
                              `You're delegating ${stakingAmountTotalComputed} ZRX to ${
                                  selectedStakingPools.length > 1
                                      ...
                                      : `${utils.getPoolDisplayName(selectedStakingPools[0].pool)}`
                              }`}
                    </CenteredHeader>
                        ...
                        selectedStakingPools.map(stakingPool => {
                            return (
                                <TransactionItem
                                    ...
                                    marketMakerName={utils.getPoolDisplayName(stakingPool.pool)}
