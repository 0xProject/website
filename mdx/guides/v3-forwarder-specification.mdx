...
<p align="center"><img src="https://github.com/0xProject/0x-protocol-specification/raw/master/img/0x_forwarder.png" width="750" /></p>
...
- Presets approval to the [ERC20Proxy](/docs/guides/v3-specification#erc20proxy) and the [ERC721Proxy](/docs/guides/v3-specification#erc721proxy)
...
The Forwarder contract pays [protocol fees](/docs/guides/v3-specification#protocol-fees) using the WETH obtained in step 1. Note that WETH spent on protocol fees is included in the total `wethSpentAmount` used to compute the Forwarder fee in step 3.
...
- The `makerAssetData` contains an [`assetProxyId`](/docs/guides/v3-specification#assetdata) that is not supported (currently ERC20 and ERC721 only)
