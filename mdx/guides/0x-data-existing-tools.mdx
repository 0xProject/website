...
[Existing Data Sources](https://raw.githubusercontent.com/0xProject/website/feat/docs/data/add-existing-tools/public/images/docs/existing-data-sources-updated.png)
...
Legacy subgraph: [ZeroEx_ExchangeProxy](https://thegraph.com/explorer/subgraph/dekz/zeroex_exchangeproxy?selected=playground)
