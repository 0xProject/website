...
* number of ZRX staked in the pool during that epoch
...
<Image src="/images/docs/rewards.png" align="center" alt="Hashing" width="700px" padding="20px" marginBottom="3rem" />
...
Protocol fees associated to a staking pool are basically the fees originated from orders that were created by the market makers registered in the pool. These fees represent the activity of the market makers behind the staking pool, and it’s a crucial . As explained in the “How are rewards calculated?” section, rewards are proportional to the share of protocol fees generated by the pool.


## What is the stake %, or stake ratio?
...
## What does it mean when a pool is under or over-staked? How do I choose the optimal parameters?

The rewards per unit of ZRX staked are maximized when your stake ratio is equal to 1. The stake ratio is calculated dividing the relative share of ZRX staked (your ZRX staked divided by the total ZRX staked in the system) by your 'liquidity share' (the fees your orders have generated divided by the total fees generated by other staked market makers). 
When these two quantities are equal, your stake ratio is 1, and your rewards per unit of ZRX staked are maximized. 
