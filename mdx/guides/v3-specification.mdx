...
The `ZeroExGovernor` is a time-locked multi-signature wallet that has permission to perform administrative functions within the protocol. For specific information on its authorized functionality, please refer to the [ZeroExGovernor specification](/docs/guides/v3-governor-specification).

## Staking

Please refer to the [Staking specification](/docs/guides/v3-staking-specification) for details on how the staking system is used within the protocol.
...
<p align="center"><img src="https://github.com/0xProject/0x-protocol-specification/raw/master/img/0x_v2_trade_erc20_erc20.png" width="750" /></p>
...
<p align="center"><img src="https://github.com/0xProject/0x-protocol-specification/raw/master/img/0x_v2_trade_erc20_erc721.png" width="750" /></p>
...
A detailed paper explaining the economics of protocol fees in 0x protocol can be found [here](https://github.com/0xProject/0x-protocol-specification/blob/master/v3/protocol-fees.pdf). The [Staking specification](/docs/guides/v3-staking-specification) also provides details on specific smart contract interactions and reward calculations within the system.
...
See the [Staking specification](/docs/guides/v3-staking-specification) for a list of events that are used within the system of staking contracts.
