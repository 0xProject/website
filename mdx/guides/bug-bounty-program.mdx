...
3.0 submissions should be based off of the contracts as of commit [fb8360edfd4f42f2d2b127b95c156eb1b0daa02b](https://github.com/0xProject/0x-monorepo/tree/fb8360edfd4f42f2d2b127b95c156eb1b0daa02b/contracts).
The following contracts are considered within scope of this bug bounty:

-   [asset-proxy/contracts/src/ERC20BridgeProxy.sol](https://github.com/0xProject/0x-monorepo/blob/fb8360edfd4f42f2d2b127b95c156eb1b0daa02b/contracts/asset-proxy/contracts/src/ERC20BridgeProxy.sol) ([specification](https://github.com/0xProject/0x-protocol-specification/blob/master/asset-proxy/erc20-bridge-proxy.md))
-   [exchange/contracts/src/Exchange.sol](https://github.com/0xProject/0x-monorepo/blob/fb8360edfd4f42f2d2b127b95c156eb1b0daa02b/contracts/exchange/contracts/src/Exchange.sol) ([specification](https://github.com/0xProject/0x-protocol-specification/blob/master/v3/v3-specification.md))
-   [multisig/contracts/src/ZeroExGovernor.sol](https://github.com/0xProject/0x-monorepo/blob/fb8360edfd4f42f2d2b127b95c156eb1b0daa02b/contracts/multisig/contracts/src/ZeroExGovernor.sol) ([specification](https://github.com/0xProject/0x-protocol-specification/blob/master/v3/zero-ex-governor.md))
-   [staking/contracts/src/Staking.sol](https://github.com/0xProject/0x-monorepo/blob/fb8360edfd4f42f2d2b127b95c156eb1b0daa02b/contracts/staking/contracts/src/Staking.sol) ([specification](https://github.com/0xProject/0x-protocol-specification/blob/master/staking/staking-specification.md))
-   [staking/contracts/src/StakingProxy.sol](https://github.com/0xProject/0x-monorepo/blob/fb8360edfd4f42f2d2b127b95c156eb1b0daa02b/contracts/staking/contracts/src/StakingProxy.sol) ([specification](https://github.com/0xProject/0x-protocol-specification/blob/master/staking/staking-specification.md))
-   [staking/contracts/src/ZrxVault.sol](https://github.com/0xProject/0x-monorepo/blob/fb8360edfd4f42f2d2b127b95c156eb1b0daa02b/contracts/staking/contracts/src/ZrxVault.sol) ([specification](https://github.com/0xProject/0x-protocol-specification/blob/master/staking/staking-specification.md))

Security audits of these contracts were conducted by Trail of Bits and Consensys Diligence.

-   [Trail of Bits report](http://zeips.0x.org.s3-website.us-east-2.amazonaws.com/audits/56/trail-of-bits/audit.pdf)
-   [Consensys Diligence Exchange report](https://diligence.consensys.net/audits/2019/09/0x-v3-exchange/)
-   [Consensys Diligence Staking report](https://diligence.consensys.net/audits/2019/10/0x-v3-staking/)
...
`ERC20BridgeProxy` submissions should be based off of the contracts as of commit [281658ba349a2c5088b40b503998bea5020284a6](https://github.com/0xProject/0x-monorepo/tree/281658ba349a2c5088b40b503998bea5020284a6/contracts/asset-proxy).
The only contract within the scope of this bug bounty is:
...
`ExchangeProxy` submissions should be based off the contracts in commit [7967a8416c76e34ff5a0a4eb80e7b33ff8c0e297](https://github.com/0xProject/0x-monorepo/tree/7967a8416c76e34ff5a0a4eb80e7b33ff8c0e297/contracts/zero-ex).
The only contracts within the scope of this bug bounty are in the directory:
