...
For a full list of differences in the protocol refer to the [changelog here](https://0x.org/docs/guides/v3-specification#differences-from-20).
...
For more information on the Staking and Rebates refer to the [specification](https://0x.org/docs/guides/v3-specification#staking).
...
For more information on the Protocol Fee refer to the [documentation](https://github.com/0xProject/0x-protocol-specification/blob/3.0/v3/protocol-fees.pdf) and the [specification](https://0x.org/docs/guides/v3-specification#protocol-fees). See [Staking And Rebates](#staking-and-rebates) for additional background information on the reasoning behind the Protocol Fee.
...
For more information on Rich Reverts refer to the [documentation here](https://0x.org/docs/guides/v3-specification#rich-reverts).
...
Our primary on-chain core module is called DevUtils and [more information can be found here](https://0x.org/docs/tools/contract-wrappers).
...
The contract addresses for each network can be found in the [0x Cheat Sheet](https://0x.org/docs/guides/0x-cheat-sheet).
