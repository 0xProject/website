...
#### Creating a Margin Trading Defi Product

Power complex smart contract exchange experiences with 0x; [Learn how](/docs/guides/develop-a-margin-trading-smart-contract-with-0x-api) to leverage [Compound finance](https://compound.finance/) and 0x to build a simple margin trading experience.
