...
| Query Param          | Description                                                                                                                                                                                                         |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `sellToken`          | The ERC20 token address or symbol of the token you want to get the price of tokens in. "ETH" can be provided as a valid `sellToken`.                                                                                                      |
...
| ------------- | ----------------------------------------------------------------------|
| `symbol`      | The symbol representing the Ethereum token.                           |
| `price`       | The price, in units of `sellToken`, of one unit of `symbol` token .   |

### Examples 

#### Get price of tokens in DAI

<HttpCall path="/swap/v0/tokens?sellToken=DAI" />
