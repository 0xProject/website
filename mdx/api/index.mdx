...
| `sellToken`   | The amount of `sellToken` (in `sellToken` units) that would be sold in this swap.                                                                                                                |
...
Use "ETH" as the `sellToken` to receive a [Forwarder](/docs/guides/v3-forwarder-specification) transaction, which will allow you swap without having set allowances on your tokens.
