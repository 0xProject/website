...
| `excludedSources`          | (Optional) Liquidity sources (`Eth2Dai`, `Uniswap`, `Kyber`, `0x`) that will not be included in the provided quote. Ex: `excludedSources=Uniswap,Kyber,Eth2Dai`                                                                                                    |
