...
The documentation for the Standard Relayer API. An API specification that is implemented by several 0x Relayers, including [Radar Relay](https://developers.radarrelay.com/api/0x-sra) and [Bamboo Relay](https://sra.bamboorelay.com/zrx.html).
