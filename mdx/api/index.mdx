...
The 0x API is the easiest way to source liquidity from 0x limit orders as well as on-chain sources such as Kyber, Uniswap, Oasis, Curve and other decentralized exchange networks.
...
This API faciliates consuming the best-priced liquidity from limit orders and the greater DEX ecosystem.
...
The 0x API provides a superset of the SRA, and contains functionality that is not strictly part of the SRA spec.
