...
We offer hosted versions for different Ethereum networks. Requests for more networks, and questions/feedback in general should be directed at our [Discord](https://discord.gg/YDm4wx).
...
This API faciliates consuming the best-priced liquidity from the [0x Mesh](https://0x-org.gitbook.io/mesh/) network and the greater DEX ecosystem through the [ERC20BridgeProxy](https://github.com/0xProject/ZEIPs/issues/47).
...
| Field         | Description                                                                                                                                                                                      |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `price`       | If `buyAmount` was specified in the request it provides the price of `buyToken` in `sellToken` and vice versa. This price does not include the `slippage` provided in the request above.       |
  ...
  "orders": [
    {
      ...
      "makerAssetAmount": "1151000000000000000000",
      "takerAssetAmount": "6990479738054511026",
      "makerFee": "0",
      "takerFee": "0",
      "expirationTimeSeconds": "1579226506",
      "salt": "1579226326058",
      ...
      "signature": "0x1c3eeac38e15fda3618314cbf5ce23522edd06a51d11e8987fd67a852feadea2f564616f0e2c19da4d29737906e889372896868b5719443e683c750cd19f85e07403"
    }
  ]
}
...
```json
{
  ...
  "data": "",
  "value": "750000000606314",
  "gas": "220296",
  ...
  "orders": [
    {
      ...
      "senderAddress": "0x0000000000000000000000000000000000000000",
      "makerAssetAmount": "1151000000000000000000",
      "takerAssetAmount": "6978671011556483481",
      "makerFee": "0",
      "takerFee": "0",
      "expirationTimeSeconds": "1579227373",
      "salt": "1579227193818",
      "makerAssetData": "0xf47261b00000000000000000000000006b175474e89094c44da98b954eedeac495271d0f",
      "takerAssetData": "0xf47261b0000000000000000000000000c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2",
      "makerFeeAssetData": "0xf47261b0000000000000000000000000c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2",
      "takerFeeAssetData": "0xf47261b0000000000000000000000000c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2",
      "signature": "0x1b158d90b6c32496ec1a6c4911323e9dca53cecb2e14dff403dee194a93e72d4a16455278993b6330d2846307fc25834b60c87e21aac8b15c4609393da350440bf03"
    }
  ]
}
```
...
An API specification that is implemented by several 0x relayers (exchanges), including [Radar Relay](https://developers.radarrelay.com/api/0x-sra) and [Bamboo Relay](https://sra.bamboorelay.com/zrx.html).
It allows you to interact with the liquidity of a certain relayer, including querying and posting to their orderbook. 
In the 0x API case, it allows you to query and post to the [0x Mesh](https://0x-org.gitbook.io/mesh/) network.
...
Submit a signed order to the [0x Mesh](https://0x-org.gitbook.io/mesh/) network.
...
The server will allow you to subscribe to 0x order updates in the [0x Mesh](https://0x-org.gitbook.io/mesh/) network, 
