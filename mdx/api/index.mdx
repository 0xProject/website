...
| ----------- | -------------------------------------------------------------------------------------|
| orderHash   | The hash of the desired [0x order](/docs/core-concepts#the-0x-order-message-format). |
...
| Field       | Description                                                                                                        |
| ----------- | -------------------------------------------------------------------------------------------------------------------|
| order       | Raw signed [0x orders](/docs/core-concepts#the-0x-order-message-format).                                           |
| metaData    | Object where optional meta-data will be included, such as the `orderHash` and `remainingFillableTakerAssetAmount`. |                                                                                                                     
...
Send a partial [0x order](/docs/core-concepts#the-0x-order-message-format) to this endpoint to receive the rest of configuration-oriented fields.
