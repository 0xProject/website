...
The return format is perfect for [contract fillable liquidity](/docs/guides/contract-fillable-liquidity).
...
<HttpCall verb="POST" path="/sra/order" >
...
<HttpCall path="/sra/order/0xa1e06a9...eaa29e1a6" />
...
<HttpCall fontSize="14px" path="/sra/orderbook?baseAssetData=0xf472...6cc2&quoteAssetData=0xf472...71d0f" />
...
<HttpCall verb="POST" path="/sra/order_config">
...
<HttpCall path="/sra/fee_recipients" />
