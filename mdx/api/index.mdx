...
<HttpCall fontSize="14px" path="/orderbook/v4?quoteToken=0xc02aaa...756cc2&baseToken=0xa0b869...06eb48" />
...
<HttpCall path="/orderbook/v4/orders?makerToken=0xf47261b...756cc2" />
...
<HttpCall verb="POST" path="/orderbook/v4/order" >
...
<HttpCall verb="POST" path="/orderbook/v4/orders" >
...
## GET /orderbook/v4/order/:orderHash:
...
<HttpCall path="/orderbook/v4/order/0xa1e06a9...eaa29e1a6" />
...
## POST /orderbook/v4/order_config
...
<HttpCall verb="POST" path="/orderbook/v4/order_config">
...
## GET /orderbook/v4/fee_recipients
...
<HttpCall path="/orderbook/v4/fee_recipients" />
